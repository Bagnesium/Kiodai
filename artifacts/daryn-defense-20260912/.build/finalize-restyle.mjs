...
const result=await finalizePresentation({
 workspaceDir:root,candidatePath:root+'/.build/restyled-candidate.pptx',finalPath:root+'/output/Kiodai_Daryn_2026_redesigned.pptx',
 ...
 receiptPath:root+'/.build/validation-restyled.json'
});console.log(JSON.stringify({finalPath:result.finalPath}));
